...
global.github    = 'https://github.com/Samuel-Muli/SIGMA-MD' ;
...
global.owner = process.env.OWNER_NUMBER  || '254705244235' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
global.timezone  = process.env.TIME_ZONE || 'Africa/Nairobi' // ADD CORRECT TIMEZONE OR LEAVE IT SAME , OTHERWISE YOU GET ERROS
//=================================================================================


//======================[YOUR CHOICE, CHANGE OR LEAVE IT SAME]=====================
global.sudo  =  process.env.SUDO || "254705244235" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"SaMuli",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://www.youtube.com' ; 
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/156af7fa7b16f2915a1bb.jpg' ;
//=================================================================================
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'Lost_Boy🦜',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Samuel Muli`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'lost_boy🦜',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "lost_boy🦜" ,          // ADD YOUR STICKER PACKNAME
  ...
  caption :process.env.CAPTION || "*•Lost_Boy🦜 мυℓтι-∂єνι¢є*\n*• ωнαтѕαρρ вσт* ",
